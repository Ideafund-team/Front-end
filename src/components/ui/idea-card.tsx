            ...
            <div className="relative">
              <PhotoProvider>
                <PhotoView src={ide.image}>
                  <Image src={ide.image} width={100} height={100} alt={ide.title} className="w-full rounded-md aspect-video object-cover cursor-pointer hover:brightness-75 transition-all duration-200" unoptimized />
                </PhotoView>
              </PhotoProvider>
